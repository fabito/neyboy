...
try:
    ...
    MPI = None
from neyboy.baselines.ppo2.runner import Runner
...
def learn(*, network, env, total_timesteps, eval_env = None, seed=None, nsteps=2048, ent_coef=0.0, lr=3e-4,
          ...
          save_interval=0, load_path=None, model_fn=None, update_fn=None, init_fn=None, mpi_rank_weight=1, comm=None, callback=None, **network_kwargs):
    '''
