...
@gin.configurable
def create_neyboy_environment(version='v0'):
  """Wraps a Neyboy environment with some basic preprocessing.
  ...
  """
  full_game_name = 'neyboy-{}'.format(version)
  ...
  # by Dopamine.
  env = NeyboyPreprocessing(env)
  return env


@gin.configurable
class NeyboyPreprocessing(object):
